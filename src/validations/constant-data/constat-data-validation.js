...
const validateAddConstantBikePayload = (payload) => {
	const schema = Joi.object({
		...
		bikeType: Joi.string()
			.valid('SPORTS', 'COMMUTER', 'STANDARD', 'TOURING', 'CHOPPER', 'CRUISER', 'DIRT', 'ENDURO')
			.required(),
		...
		engineCooling: Joi.string().valid('LIQUID_COOL', 'WATER_COOL', 'AIR_COOL').required(),
		...
		startingMethod: Joi.string().valid('ELECTRIC', 'KICK', 'ELECTRIC_AND_KICK').required(),
